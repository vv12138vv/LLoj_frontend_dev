<template>
    <div>
        <div v-if="!mobileNar" id="header">
            <el-menu :default-active="activeMenuName" active-text-color="#2196f3" mode="horizontal" router
                text-color="#495060">
                <div class="logo">
                    <el-image :src="imgUrl" fit="scale-down" style="width: 130px; height: auto"></el-image>
                </div>
                ...
                <el-menu-item index="/team">
                    <i class="el-icon-s-promotion"></i>{{ $t('m.Team') }}
                </el-menu-item>
                ...
                <template v-if="!isAuthenticated">
                    <div class="btn-menu">
                        <el-button round type="primary" @click="handleBtnClick('Login')">{{ $t('m.NavBar_Login') }}
                        </el-button>
                        <el-button v-if="websiteConfig.register" round style="margin-left: 5px" type="danger"
                            @click="handleBtnClick('Register')">{{ $t('m.NavBar_Register') }}
                        </el-button>
                    </div>
                </template>
                <template v-else>
                    <el-dropdown class="drop-menu" placement="bottom" trigger="click" @command="handleRoute">
                    ...
                    <avatar :inline="true" :size="30" :src="avatar" :username="userInfo.username" class="drop-avatar"
                        color="#FFF"></avatar>
                    <el-dropdown class="drop-msg" placement="bottom" @command="handleRoute">
                        <span class="el-dropdown-link">
                            ...
                            " height="10" style="vertical-align: top;margin-left: -11px;margin-top: 3px;" width="10">
        ...
        <div v-else style="top:0px;left:0px;">
            <mu-appbar class="mobile-nav" color="primary">
                ...
                <mu-button v-show="!isAuthenticated" slot="right" flat @click="handleBtnClick('Login')">{{
                    $t('m.NavBar_Login')
                    }}
                </mu-button>
                <mu-button v-show="!isAuthenticated && websiteConfig.register" slot="right" flat
                    @click="handleBtnClick('Register')">{{ $t('m.NavBar_Register') }}
                </mu-button>
                ...
                <mu-menu v-show="isAuthenticated" slot="right" :open.sync="openmsgmenu">
                    <mu-button flat>
                        ...
                        <svg v-if="
                            ...
                            unreadMessage.sys > 0 ||
                            unreadMessage.mine > 0
                        " height="10" style="margin-left: -11px;margin-top: -13px;" width="10">
                            <circle cx="5" cy="5" r="5" style="fill: red;"></circle>
                        </svg>
                    </mu-button>
                ...
                <mu-menu v-show="isAuthenticated" slot="right" :open.sync="openusermenu">
                    <mu-button flat>
                        <avatar :inline="true" :size="30" :src="userInfo.avatar" :title="userInfo.username"
                            :username="userInfo.username" color="#FFF"></avatar>
            ...
            <mu-drawer :docked="false" :open.sync="opendrawer" :right="false">
                <mu-list toggle-nested>
                    <mu-list-item active-class="mobile-menu-active" button to="/home" @click="opendrawer = !opendrawer">
                        <mu-list-item-action>
                    ...
                    <mu-list-item active-class="mobile-menu-active" button to="/problem"
                    ...
                    <mu-list-item active-class="mobile-menu-active" button to="/training"
                        @click="opendrawer = !opendrawer">
                        <mu-list-item-action>
                    ...
                    <mu-list-item active-class="mobile-menu-active" button to="/contest"
                        @click="opendrawer = !opendrawer">
                        <mu-list-item-action>
                    ...
                    <mu-list-item active-class="mobile-menu-active" button to="/status"
                        @click="opendrawer = !opendrawer">
                        <mu-list-item-action>
                    ...
                    <mu-list-item :open="openSideMenu === 'rank'" :ripple="false" button nested
                        ...
                        <mu-list-item slot="nested" :ripple="false" active-class="mobile-menu-active" button
                            to="/acm-rank" @click="opendrawer = !opendrawer">
                            <mu-list-item-title>{{
                                $t('m.NavBar_ACM_Rank')
                                }}
                            </mu-list-item-title>
                        ...
                        <mu-list-item slot="nested" :ripple="false" active-class="mobile-menu-active" button
                            to="/oi-rank" @click="opendrawer = !opendrawer">
                            <mu-list-item-title>{{
                                $t('m.NavBar_OI_Rank')
                                }}
                            </mu-list-item-title>
                    ...
                    <mu-list-item active-class="mobile-menu-active" button to="/discussion"
                        @click="opendrawer = !opendrawer">
                        <mu-list-item-action>
                    ...
                    <mu-list-item active-class="mobile-menu-active" button to="/team"
                        @click="opendrawer = !opendrawer">
                        <mu-list-item-action>
                            <mu-icon size="24" value=":el-icon-s-promotion"></mu-icon>
                        </mu-list-item-action>
                        <mu-list-item-title>{{
                            $t('m.Team')
                            }}
                    ...
                    <mu-list-item active-class="mobile-menu-active" button to="/introduction"
                        @click="opendrawer = !opendrawer">
                        <mu-list-item-action>
        ...
        <el-dialog :close-on-click-modal="false" :title="title" :visible.sync="modalVisible" class="dialog"
            width="370px">

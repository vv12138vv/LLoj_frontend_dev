<template>
  <div>
    <div v-loading="loading" class="container">
      <div class="title-article" style="text-align: left">
        ...
        <div class="title-msg">
          ...
          <span v-show="userInfo.uid == discussion.uid" style="padding:0 6px;"
      ...
      <div class="body-article">
        ...
        >
          <div v-highlight class="markdown-body" v-html="contentHtml"></div>
        </template>
        <template v-else>
          <div
    ...
    >
      <el-form :model="discussion" label-position="top">
        ...
        <el-form-item :label="$t('m.Discussion_Category')" required>
          <el-select v-model="discussion.categoryId" disabled placeholder="---">
            <el-option

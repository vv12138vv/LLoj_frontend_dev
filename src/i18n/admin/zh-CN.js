export const m = {
    ...
    All_user_submissions: '所有用户的提交',
    All_Status_submissions: '所有状态的提交',
    AC_Status_submissions: 'AC状态的提交',
